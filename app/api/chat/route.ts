...
export async function POST(req: Request) {
    try{
        ...
        const appMessage = "The app is located at the right side of this chatbox. User can either click the pupil or download it using this link 'https://apps.apple.com/us/app/opto-screen/id1495864206'"
        ...
        const response = await openai.chat.completions.create({
            ...
            stream: true,
            messages: [{role: "system", content: introductionMessage + dataMessage + restrictionsMessage}, ...messagesTruncated]
        })
